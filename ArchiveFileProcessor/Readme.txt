This Module deals with the extraction of Zip Files and Jar Files.

Two modes of processing are available as of now.
  ...
  2. Processing a folder containing the archives.
      ...
      Contents will be extracted to a folder whose name is same as the Zip/Jar file name.
